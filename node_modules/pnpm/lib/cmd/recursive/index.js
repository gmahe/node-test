    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (cmdFullName !== 'rebuild') {
            ...
            if (opts.shrinkwrapDirectory && ['install', 'uninstall', 'update'].indexOf(cmdFullName) !== -1) {
                ...
                pkgPaths = yield pFilter(pkgPaths, (pkgPath) => __awaiter(this, void 0, void 0, function* () { return isFromWorkspace(yield fs.realpath(pkgPath)); }));
                ...
                const importers = yield Promise.all(pkgPaths.map((prefix) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield supi_1.mutateModules(importers, Object.assign({}, installOpts, { hooks, storeController: store.ctrl }));
                return true;
            }
